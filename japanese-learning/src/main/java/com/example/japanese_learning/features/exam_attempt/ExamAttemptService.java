...
import com.example.japanese_learning.features.exam_attempt.repository.StudentAnswerRepository;
...
public class ExamAttemptService {
    ...
    // Nếu người dùng chủ động thoát thì xóa sạch dữ liệu bài làm
    @Transactional(rollbackFor = Exception.class)
    public void cancelExamAttempt(Long attemptId) {
