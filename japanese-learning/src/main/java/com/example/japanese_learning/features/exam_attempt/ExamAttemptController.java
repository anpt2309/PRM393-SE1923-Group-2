...
public class ExamAttemptController {
    ...
    @DeleteMapping("/exams/attempt/{attemptId}")
    public ApiResponse<Void> cancelExamAttempt(@PathVariable(name = "attemptId") Long attemptId) {
        examAttemptService.cancelExamAttempt(attemptId);
        ApiResponse<Void> apiResponse = ApiResponse.<Void>builder()
                .id(200)
                .message("Hủy phiên thi thành công")
                .build();
        return apiResponse;
    }
}
