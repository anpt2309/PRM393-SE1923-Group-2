...
import 'package:japanese_learning/main.dart'; // Import để lấy cấu hình appSettings toàn cục
  ...
  Widget build(BuildContext context) {
    return ListenableBuilder(
      ...
      builder: (context, child) {
        ...
        // 🌟 BẢNG MÀU ĐƯỢC TINH CHỈNH THEO ẢNH ZALO CỦA BẠN
        final Color zaloBlue = Colors.blue; // Màu xanh Blue thương hiệu từ ảnh Zalo
        ...
        return AppBar(
          ...
          elevation: elevation ?? 0, // Phẳng hoàn toàn, không đổ bóng, đúng tinh thần tối giản hiện đại của Zalo
